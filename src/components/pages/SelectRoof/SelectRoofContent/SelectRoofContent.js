...
const SelectRoofContent = ({
  ...
  const googleMapImageURL = () => {
    ...
    imageURL = `https://maps.googleapis.com/maps/api/staticmap?center=${globalCenterPos_Y},${globalCenterPos_X}&zoom=18&scale=1&size=1000x1000&maptype=satellite&format=png&visual_refresh=true&key=AIzaSyDSNNi3altaClp_oQKogzkaETu0TbHWBIs`;
