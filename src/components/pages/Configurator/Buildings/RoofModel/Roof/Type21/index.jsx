...
const Type21 = ({ item, roofThickness, overHang, roofTexture, wallTexture }) => {
    ...
    const model = useMemo(() => {
        ...
        model1.moveTo(-width / 2 + width_2 / 2, roofWidth1);
        ...
        model2.moveTo(0, length / 2 - width_1);
        model2.lineTo(0, -length / 2);
        model2.lineTo(-roofWidth2, -length/2);
    ...
    const coverModel = useMemo(() => {
        ...
        model_1_base.moveTo( -width / 2 + width_2, 0);
        ...
        model_2_base.lineTo( length / 2 - width_1, 0 );
    ...
    return (
        <group>
            <group name='roof-model-1'>
                <group>
                    <mesh name='roof-model-2-1-1' position={[0, height, -(length / 2 - width_1)]} rotation={[-model.angle1, 0, 0]} scale={[1, 1, 0.1]}>
            ...
            <group name='roof-model-3'>
                ...
                <group position={[0, height, -length / 2]}>
                    <mesh name='model_3_base' scale={[1, 1, 0.1]}>
            ...
            <group name='roof-model-4'>
                ...
                <group position={[-width / 2 + roofThickness, 0, length / 2 ]}>
                    <mesh name='model_4_slope' position={[0, height, 0]} scale={[1, 1, 0.1]}>
