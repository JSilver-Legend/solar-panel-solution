...
const Type41 = ({ item, ridgeWidth, ridgeThickness }) => {
    ...
    const ridgeModel = useMemo(() => {
        ...
        const ridge_12_front_end_width = ridge_12_vertical_height / Math.tan(angle34);
        const ridge_12_back_end_width =  ridge_12_vertical_height / Math.tan(angle56)
        ...
        model_1_ridge.moveTo( -length / 2 + width_1 / 2, 0 );
        model_1_ridge.lineTo( length / 2 - width_2 / 2, 0 );
        model_1_ridge.lineTo( length / 2 -width_2 / 2 - ridge_12_back_end_width, -ridgeWidth );
        model_1_ridge.lineTo( -length / 2 + width_1 / 2 + ridge_12_front_end_width, -ridgeWidth );
        model_1_ridge.closePath();

        const model_2_ridge = new THREE.Shape();
        model_2_ridge.moveTo( -length / 2 + width_1 / 2, 0 );
        model_2_ridge.lineTo( length / 2 - width_2 / 2, 0 );
        model_2_ridge.lineTo( length / 2 -width_2 / 2 + ridge_12_back_end_width, -ridgeWidth );
        model_2_ridge.lineTo( -length / 2 + width_1 / 2 - ridge_12_front_end_width, -ridgeWidth );
        model_2_ridge.closePath();

        const model_3_ridge = new THREE.Shape();
        model_3_ridge.moveTo( -width / 2 + length_2 / 2, 0 );
        model_3_ridge.lineTo( width / 2, 0 );
        model_3_ridge.lineTo( width / 2, -ridgeWidth );
        model_3_ridge.lineTo( -width / 2 + length_2 / 2 + ridge_34_end_width, -ridgeWidth );
        model_3_ridge.closePath();

        const model_4_ridge = new THREE.Shape();
        model_4_ridge.moveTo( -width / 2 + length_2 / 2, 0 );
        model_4_ridge.lineTo( width / 2, 0 );
        model_4_ridge.lineTo( width / 2, -ridgeWidth );
        model_4_ridge.lineTo( -width / 2 + length_2 / 2 - ridge_34_end_width, -ridgeWidth );
        model_4_ridge.closePath();

        const model_5_ridge = new THREE.Shape();
        model_5_ridge.moveTo( -width / 2 + length_2 / 2, 0 );
        model_5_ridge.lineTo( width / 2, 0 );
        model_5_ridge.lineTo( width / 2, -ridgeWidth );
        model_5_ridge.lineTo( -width / 2 + length_2 / 2 + ridge_56_end_width, -ridgeWidth );
        model_5_ridge.closePath();

        const model_6_ridge = new THREE.Shape();
        model_6_ridge.moveTo( -width / 2 + length_2 / 2, 0 );
        model_6_ridge.lineTo( width / 2, 0 );
        model_6_ridge.lineTo( width / 2, -ridgeWidth );
        model_6_ridge.lineTo( -width / 2 + length_2 / 2 - ridge_56_end_width, -ridgeWidth );
        ...
        <group>
            <group name='ridge-model'>
                <group name='model_1_ridge' rotation={[0, Math.PI / 2, 0]}>
                    <mesh castShadow position={[0, height + pitch + 3 * ridgeThickness, -(width / 2 - length_2 / 2)]} rotation={[-(Math.PI / 2 - ridgeModel.angle12), 0, 0]} scale={[1, 1, 0.01]}>
            ...
            <group name='ridge-model'>
                <group name='model_3_ridge'>
                    <mesh castShadow position={[0, height + pitch + 3 * ridgeThickness, length / 2 - width_1 / 2]} rotation={[(Math.PI / 2 - ridgeModel.angle34), 0, 0]} scale={[1, 1, 0.01]}>
            ...
            <group name='ridge-model'>
                <group name='model_5_ridge'>
                    <mesh castShadow position={[0, height + pitch + 3 * ridgeThickness, -(length / 2 - width_2 / 2)]} rotation={[-(Math.PI / 2 - ridgeModel.angle56), 0, 0]} scale={[1, 1, 0.01]}>
