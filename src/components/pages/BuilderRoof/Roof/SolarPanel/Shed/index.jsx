...
const SolarPanelShed = ({ buildingIndex, buildingWidth, buildingLength, buildingHeight, roofHeight, solarWidth, solarLength, solarHeight, solarColor, onObstacleData, ridgeDirection, buildingDirection, solarStyle }) => {
    ...
    return (
        <group>
            {solarDataArray?.map((item, index) => (
                <group key={`solar-shed-${index}`} position={item.position} rotation={item.rotation}>
